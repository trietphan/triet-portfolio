    ...
    <div className="min-h-screen" style={{ background: "#0a0a1a", color: "#e0e0f0" }}>
      ...
      <div className="fixed top-0 left-0 right-0 z-50 backdrop-blur-xl border-b"
        ...
        <div className="max-w-3xl mx-auto px-6 py-4 flex items-center justify-between">
          <Link href="/#blog" data-hover="true"
      ...
      <article className="max-w-3xl mx-auto px-6 pt-28 pb-24">
        <div className="flex items-center gap-3 mb-8">
          <span className="px-3 py-1 rounded-full text-xs font-mono uppercase tracking-wider border"
            style={{ borderColor: `${post.color}25`, color: post.color, backgroundColor: `${post.color}10` }}>
            {post.tag}
          </span>
        ...
        <h1 className="font-black mb-10 leading-tight"
          style={{ fontSize: "clamp(26px, 5vw, 44px)", color: "rgba(255,255,255,0.92)" }}>
          {post.title}
        </h1>

        <div className="w-14 h-0.5 mb-10 rounded-full"
        ...
        <div className="space-y-6">
          {paragraphs.map((para, i) => (
            <p key={i} style={{
              ...
              lineHeight: "1.9", fontSize: "17px", fontWeight: 300,
            }}>
              {para}
            </p>
          ))}
        ...
        <div className="flex items-center gap-4 p-6 rounded-2xl border border-white/5"
          ...
          <Link href="/#contact" data-hover="true"
        ...
        <div className="mt-10 flex items-center justify-between">
          <Link href="/#blog" data-hover="true"
            className="text-sm font-medium flex items-center gap-2 hover:opacity-80"
            style={{ color: "#ffaa33" }}>
            <svg width="15" height="15" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
              <path d="M19 12H5M12 5l-7 7 7 7" />
            </svg>
