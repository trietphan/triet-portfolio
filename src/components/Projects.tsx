...
const projects = [
  ...
  },
  {
    ...
    description:
      "An interactive market profile and trading education website, helping traders understand price action, volume analysis, and market structure.",
    longDescription: null,
  ...
  },
  {
    ...
    description:
      "A resource management application built for Airbnb's operations team on monday.com. Full-cycle development with GraphQL + REST API integration.",
    longDescription:
      "Built for Airbnb's operations team, this monday.com application focused on modularity, scalability, and deep GraphQL/REST API integration. Adopted by over 200 team members, it enhanced project coordination and resource allocation across the organization.",
