...
const items = [
  {
    icon: "🧠",
    label: "Building",
    value: "ClawSwarm v2 — multi-agent orchestration",
    color: "#b347ff",
  },
  {
    icon: "⚡",
    label: "Shipping",
    value: "AgentAwake — AI productivity SaaS",
    color: "#ff6b2b",
  },
  {
    icon: "📚",
    label: "Teaching",
    value: "CIS at Wilbur Wright College",
    color: "#00fff5",
  },
  {
    icon: "🔍",
    label: "Exploring",
    value: "LLM reasoning, agent memory & RAG systems",
    color: "#ffaa33",
  },
  {
    icon: "🌐",
    label: "Learning",
    value: "Web3, smart contracts & on-chain apps",
    color: "#00ff88",
  },
  {
    icon: "🎯",
    label: "Goal",
    value: "Ship tools that genuinely change how people work",
    color: "#f5ff00",
  },
];
      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          <p className="text-white/30 max-w-sm mx-auto text-sm">
            A living snapshot. Updated regularly.
          </p>
        </motion.div>
